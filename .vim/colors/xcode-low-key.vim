...
call <sid>hi("CursorLineNr",  s:gray, s:very_light_gray, "8", "7", "")
...
hi GitGutterAdd			    ctermbg=NONE	ctermfg=7		cterm=NONE
hi GitGutterChange			ctermbg=NONE	ctermfg=7		cterm=NONE
hi GitGutterDelete			ctermbg=NONE	ctermfg=7		cterm=NONE
hi GitGutterChangeDelete	ctermbg=NONE    ctermfg=7		cterm=NONE
